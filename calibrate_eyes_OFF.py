...
class Main:
    ...
    def run(self):
        ...
        calibrating = False
        f = open("data/on_screen_look_data.csv", "a")


        datapoints = 0

        while datapoints < 500:
            ...
            if debug:  # face
                ...
                if calibrating is False:
                    print("Preparing to collect eyes off screen looking data")
                    print("Tap enter when you are ready")
                    input()
                    calibrating = True
                
                if self.gaze is not None:
                    for datapoint in self.gaze:
                        #print(datapoint)
